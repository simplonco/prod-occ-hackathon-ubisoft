...
<section class="about-us" id="aboutus">
	...
	<div class="container">
		...
		<?php
			...
			if ( defined( 'THEMEISLE_COMPANION_VERSION' ) ) {
				$zerif_aboutus_text_default = 'Lorem ipsum dolor sit amet';
			}
			if ( current_user_can( 'edit_theme_options' ) ) {
		...
		<div class="col-lg-<?php echo $colCount; ?> col-md-<?php echo $colCount; ?> column zerif-rtl-skills ">
			<?php get_template_part( "sections/aboutus-subtitle" ); ?>
			...
			<?php get_template_part( 'sections/aboutus-postcontent' ) ?>
